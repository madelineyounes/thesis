...
print("First data: ", encoded_data[0])
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if self.config.problem_type == "regression":
                ...
                print("LOSS LABELS,", torch.stack(labels))
                loss = loss_fct(logits.view(-1, self.num_labels), torch.stack(labels))
...
class myTrainer(Trainer):
    ...
    def _train(self, loader):
        ...
        for data in loader:
            ...
            # loss
            loss = self._compute_loss(model, inputs, labels)
