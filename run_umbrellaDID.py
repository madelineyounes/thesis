...
encoded_data = data
encoded_data["test"] = data["test"].map(audio_to_array_fn, remove_columns=["id"], num_proc=4)
encoded_data["train"] = data["train"].map(audio_to_array_fn,remove_columns=["id"], num_proc=4)
