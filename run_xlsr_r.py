...
import customTransform as T
from customDataRegional import CustomDataset
...
checkpoint = "/srv/scratch/z5208494/checkpoint/20211018-base-intial-test-xlsr"
if use_checkpoint:
...
label_list = ['EGY', 'SDN', 'IRQ', 'KWT', 'ARE', 'QAT', 'OMN', 'SAU', 'YEM', 'PSE', 'LBN', 'SYR', 'JOR', 'MRT', 'MAR', 'DZA', 'LBY']
